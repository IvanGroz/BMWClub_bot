...
class SimpleCalendar:
    ...
    async def start_calendar(
        ...
        inline_kb.insert(InlineKeyboardButton(
            ">>",
            callback_data=simple_calendar_callback.new("NEXT-YEAR", year, month, 1)
        ))
        ...
        inline_kb.row()
        inline_kb.insert(InlineKeyboardButton(
            "<", callback_data=simple_calendar_callback.new("PREV-MONTH", year, month, day)
        ))
        inline_kb.insert(InlineKeyboardButton(" ", callback_data=ignore_callback))
        inline_kb.insert(InlineKeyboardButton(
            ">", callback_data=simple_calendar_callback.new("NEXT-MONTH", year, month, day)
        ))
